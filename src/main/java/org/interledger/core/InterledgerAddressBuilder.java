 ...
 * <p>
 * <em>{@code InterledgerAddressBuilder} is not thread-safe and generally should not be stored in a field or collection,
...
public class InterledgerAddressBuilder {
    ...
    public InterledgerAddressBuilder(final InterledgerAddress interledgerAddress) {
        this.value = Objects.requireNonNull(interledgerAddress, "InterledgerAddress must not be null!").getValue();
    }

    /**
     * Builder method to actually construct an instance of {@link InterledgerAddress} from the data in this builder.
     *
     * @return
     */
     ...
     *
     * @param value A {@link String} representing this builder's "value", which is the string version of an Interledger
     *              Address.
     */
    ...
    /**
     * A private, immutable implementation of {@link InterledgerAddress}.  To construct an instance of this class, use
     * an instance of {@link InterledgerAddressBuilder}.
     */
    private static final class InterledgerAddressImpl implements InterledgerAddress {
         ...
         *
         * @param builder An non-null instance of {@link InterledgerAddressBuilder} to construct a new instance from.
         */
        ...
        /**
         * Helper method to determine if an Interledger Address conforms to the specifications outlined in Interledger
         * RFC #15.
         *
         * @param value A {@link String} representing a potential Interledger Address value.
         * @return {@code true} if the supplied {@code value} conforms to the requirements of RFC 15; {@code false}
         * otherwise.
        ...
        /**
         * Accessor method for this address's {@link String} value.
         * <p>
         * NOTE: This is distinct from {@link InterledgerAddressImpl#toString()} to allow for the two values to diverge,
         * e.g., for debugging or logging purposes.
         *
        ...
        public boolean equals(Object o) {
            ...
            InterledgerAddressImpl interledgerAddressImpl = (InterledgerAddressImpl) o;
