...
public class OerLengthPrefixCodecTest {
   ...
   */
  public OerLengthPrefixCodecTest(
  ...
  public void setUp() throws Exception {
    ...
    codecContext = new CodecContext()
        .register(OerLengthPrefix.class, oerLengthPrefixCodec);
  }
  ...
  public void read() throws Exception {
    ...
    final int actualPayloadLength = oerLengthPrefixCodec.read(codecContext, inputStream)
        .getLength();
  ...
  public void write() throws Exception {
    ...
    oerLengthPrefixCodec
        .write(codecContext, new OerLengthPrefix(expectedPayloadLength), outputStream);
  ...
  public void writeThenRead() throws Exception {
    ...
    final ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
    oerLengthPrefixCodec
        .write(codecContext, new OerLengthPrefix(this.expectedPayloadLength), outputStream);
