 ...
 */
public class BilateralTransferProtocolCodecContext extends CodecContext {
   ...
   */
  private final Map<BilateralTransferProtocolPacketType, Class<?>> btpPacketCodecs;

  /**
   * No-args Constructor.
   */
  public BilateralTransferProtocolCodecContext() {
    super();
   ...
   *
   * @return A {@link BilateralTransferProtocolCodecContext} for the supplied {@code type}.
   */
  public <T> BilateralTransferProtocolCodecContext register(final Class<T> type,
      final Codec<T> converter) {
    Objects.requireNonNull(type);
    Objects.requireNonNull(converter);
    if (converter instanceof BilateralTransferProtocolPacketCodec<?>) {
      BilateralTransferProtocolPacketCodec<?> commandTypeConverter =
          (BilateralTransferProtocolPacketCodec) converter;
   ...
   *
   * @param typeId      An instance of {@link BilateralTransferProtocolPacketType}.
   ...
   */
  public BilateralTransferProtocolPacket read(final BilateralTransferProtocolPacketType typeId,
  ...
  public BilateralTransferProtocolPacket readBtpPacket(final InputStream inputStream)
    ...
    final BilateralTransferProtocolPacketType type = BilateralTransferProtocolPacketType.fromTypeId(
        inputStream.read());
   ...
   * BilateralTransferProtocolCodecContext}, and
   ...
   *
   * @return An instance of {@link BilateralTransferProtocolCodecContext} for further operations.
   */
  public <T> BilateralTransferProtocolCodecContext write(final Class<T> type, final T instance,
   ...
   * @return An instance of {@link BilateralTransferProtocolCodecContext} for further operations.
   */
  public BilateralTransferProtocolCodecContext write(final Object instance,
   ...
   * @param typeId An instance of {@link BilateralTransferProtocolPacketType}.
   */
  private Codec<?> lookup(final BilateralTransferProtocolPacketType typeId) {
    if (btpPacketCodecs.containsKey(typeId)) {
      return lookup(btpPacketCodecs.get(typeId));
    }
    throw new CodecException(
        "No " + BilateralTransferProtocolPacketCodec.class.getName() + " registered for typeId "
            + typeId);
  }
