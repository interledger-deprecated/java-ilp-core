 ...
 */
public class MessageOerCodec implements MessageCodec {

  @Override
  public MessagePacket read(final CodecContext context, final InputStream inputStream)
      throws IOException {
    ...
    return ImmutableMessagePacket.builder()
        .requestId(requestId)
  ...
  @Override
  public void write(final CodecContext context, final MessagePacket instance,
