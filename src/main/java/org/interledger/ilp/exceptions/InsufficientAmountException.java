...
public class InsufficientAmountException extends InterledgerException {
  ...
  /**
   * Creates a new instance of {@code InsufficientAmountException} without detail message.
   */
  public InsufficientAmountException() {}

  /**
   * Constructs an instance of {@code InsufficientAmountException} with the specified detail
   * message.
   *
