 ...
 *
 * <p>
 * <b>Destination Addresses</b> are complete addresses that can receive payments. A destination
 ...
 * an individual ledger or sub-ledger; or entire neighborhoods of ledgers.  Address prefixes MUST
 * end in a period (.) character.
 * </p>
 *
 * <p> The formal specification for an Interledger Addresses is defined in
 * <a href="https://github.com/interledger/rfcs/tree/master/0015-ilp-addresses">Interledger
 * RFC #15</a>.
 * </p>
 *
...
public interface InterledgerAddress {
  ...
  /**
   * Return a new InterledgerAddress by postfixing {@code segment} to this address.
   *
   * <p>
   * For example, if this address is '<code>us.usd</code>', then calling this method with an
   * argument of '<code>bob</code>' would result in a new Interledger Address with a value of
   * '<code>us.usd.bob</code>'.
   * </p>
   *
   * @param segment A {@link String} to be appended to this address as an additional, yet final,
   *     segment.
