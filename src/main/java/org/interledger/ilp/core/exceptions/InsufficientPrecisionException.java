...
public class InsufficientPrecisionException extends InterledgerException {
	...
	/**
	 * Creates a new instance of <code>InsufficientPrecisionException</code> without detail message.
	 */
	public InsufficientPrecisionException() {
	}

	/**
	 * Constructs an instance of <code>InsufficientPrecisionException</code> with the specified detail
	 * message.
	 *
