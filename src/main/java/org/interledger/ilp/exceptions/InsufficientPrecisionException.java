...
public class InsufficientPrecisionException extends InterledgerException {
  ...
  /**
   * Creates a new instance of {@code InsufficientPrecisionException} without detail message.
   */
  public InsufficientPrecisionException() {}

  /**
   * Constructs an instance of {@code InsufficientPrecisionException} with the specified detail
   * message.
   *
