...
public class LedgerTransferException extends InterledgerException {
  ...
  /**
   * Creates a new instance of {@code LedgerTransferException} without detail message.
   */
  public LedgerTransferException() {}

  /**
   * Constructs an instance of {@code LedgerTransferException} with the specified detail message.
   *
