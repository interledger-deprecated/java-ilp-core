...
public class BilateralTransferProtocolErrorTypeOerCodec implements
  ...
  public void write(final CodecContext context,
    ...
    final BilateralTransferProtocolErrorTypes errorType = instance.getValue();
  ...
  public static class OerBilateralTransferProtocolErrorTypes {
    ...
    private final BilateralTransferProtocolErrorTypes value;

    /**
     * Construct from {@link BilateralTransferProtocolErrorTypes}
     *
     * @param value An instance of {@link BilateralTransferProtocolErrorTypes}
     */
    public OerBilateralTransferProtocolErrorTypes(final BilateralTransferProtocolErrorTypes value) {
    ...
    public OerBilateralTransferProtocolErrorTypes(final String code, final String name) {
      ...
      value = BilateralTransferProtocolErrorTypes.fromCode(code);
    ...
    /**
     * Accessor for the value of this error type, as a {@link BilateralTransferProtocolErrorTypes}.
     *
     * @return An instance of {@link BilateralTransferProtocolErrorTypes}.
     */
    public BilateralTransferProtocolErrorTypes getValue() {
      return value;
    }
