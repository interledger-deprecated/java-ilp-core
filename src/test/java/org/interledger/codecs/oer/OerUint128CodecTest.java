...
public class OerUint128CodecTest {
    ...
    return Arrays.asList(new Object[][]
        {
            ...
            // 27
            {new BigInteger("72057594037927934"), resizeArray(Longs.toByteArray(72057594037927934L))},
            // 28 (max 7-bit long value)
            {new BigInteger("72057594037927935"), resizeArray(Longs.toByteArray(72057594037927935L))},

            // Eight Bytes (64 bits)
            // 29
            {new BigInteger("72057594037927936"), resizeArray(Longs.toByteArray(72057594037927936L))},
            // 30
            {new BigInteger("72057594037927937"), resizeArray(Longs.toByteArray(72057594037927937L))},
            ...
            // 36
            {new BigInteger("4722366482869645213694"), resizeArray(createArray(9, 0xFF, 0xFF, 0xFE))},
            // 37
            {new BigInteger("4722366482869645213695"), resizeArray(createArray(9, 0xFF, 0xFF, 0xFF))},
            
            // Ten Bytes (80 bits)
            // 38
            {new BigInteger("4722366482869645213696"), resizeArray(createArray(10, 0x01, 0x00, 0x00))},
            // 39
            {new BigInteger("4722366482869645213697"), resizeArray(createArray(10, 0x01, 0x00, 0x01))},
            // 40
            {new BigInteger("1208925819614629174706174"), resizeArray(createArray(10, 0xFF, 0xFF, 0xFE))},
            // 41
            {new BigInteger("1208925819614629174706175"), resizeArray(createArray(10, 0xFF, 0xFF, 0xFF))},

            // Eleven Bytes (88 bits)
            // 42
            {new BigInteger("1208925819614629174706176"), resizeArray(createArray(11, 0x01, 0x00, 0x00))},
            // 43
            {new BigInteger("1208925819614629174706177"), resizeArray(createArray(11, 0x01, 0x00, 0x01))},
            // 44
            {new BigInteger("309485009821345068724781054"), resizeArray(createArray(11, 0xFF, 0xFF, 0xFE))},
            // 45
            {new BigInteger("309485009821345068724781055"), resizeArray(createArray(11, 0xFF, 0xFF, 0xFF))},

            // Twelve Bytes (96 bits)
            // 46
            {new BigInteger("309485009821345068724781056"), resizeArray(createArray(12, 0x01, 0x00, 0x00))},
            // 47
            {new BigInteger("309485009821345068724781057"), resizeArray(createArray(12, 0x01, 0x00, 0x01))},
            // 48
            {new BigInteger("79228162514264337593543950334"), resizeArray(createArray(12, 0xFF, 0xFF, 0xFE))},
            // 49
            {new BigInteger("79228162514264337593543950335"), resizeArray(createArray(12, 0xFF, 0xFF, 0xFF))},
            
            // Thirteen Bytes (104 bits)
            // 50
            {new BigInteger("79228162514264337593543950336"), resizeArray(createArray(13, 0x01, 0x00, 0x00))},
            // 51
            {new BigInteger("79228162514264337593543950337"), resizeArray(createArray(13, 0x01, 0x00, 0x01))},
            // 52
            {new BigInteger("20282409603651670423947251286014"), resizeArray(createArray(13, 0xFF, 0xFF, 0xFE))},
            // 53
            {new BigInteger("20282409603651670423947251286015"), resizeArray(createArray(13, 0xFF, 0xFF, 0xFF))},
            
            // Fourteen Bytes (112 bits)
            // 54
            {new BigInteger("20282409603651670423947251286016"), resizeArray(createArray(14, 0x01, 0x00, 0x00))},
            // 55
            {new BigInteger("20282409603651670423947251286017"), resizeArray(createArray(14, 0x01, 0x00, 0x01))},
            // 56
            {new BigInteger("5192296858534827628530496329220094"), resizeArray(createArray(14, 0xFF, 0xFF, 0xFE))},
            // 57
            {new BigInteger("5192296858534827628530496329220095"), resizeArray(createArray(14, 0xFF, 0xFF, 0xFF))},

            // Fifteen Bytes (120 bits)
            // 54
            {new BigInteger("5192296858534827628530496329220096"), resizeArray(createArray(15, 0x01, 0x00, 0x00))},
            // 55
            {new BigInteger("5192296858534827628530496329220097"), resizeArray(createArray(15, 0x01, 0x00, 0x01))},
            // 56
            {new BigInteger("1329227995784915872903807060280344574"), resizeArray(createArray(15, 0xFF, 0xFF, 0xFE))},
            // 57
            {new BigInteger("1329227995784915872903807060280344575"), resizeArray(createArray(15, 0xFF, 0xFF, 0xFF))},
            
            // Sixteen Bytes (128 bits)!
            // 58
            {new BigInteger("1329227995784915872903807060280344576"), createArray(16, 0x01, 0x00, 0x00)},
            // 59
            {new BigInteger("1329227995784915872903807060280344577"), createArray(16, 0x01, 0x00, 0x01)},
            // 60
            {new BigInteger("340282366920938463463374607431768211454"), createArray(16, 0xFF, 0xFF, 0xFE)},
            // 61
            {new BigInteger("340282366920938463463374607431768211455"), createArray(16, 0xFF, 0xFF, 0xFF)},
  ...
  public void read() throws Exception {
    ...
    final BigInteger actualValue = oerUint128Codec.read(codecContext, byteArrayInputStream).getValue();
