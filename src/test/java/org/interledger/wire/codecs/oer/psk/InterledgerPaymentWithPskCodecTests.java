...
/**
 * Unit tests to validate the {@link Codec} functionality for all {@link InterledgerPayment} packets that include PSK
 * payload data.  This test was assembled using the pseudocode instructions found in IL-RFC-16.
 *
...
public class InterledgerPaymentWithPskCodecTests {
  ...
  private static final BasicPskHeader publicHeader1 = new BasicPskHeader("question", "What is the answer?");
  private static final BasicPskHeader publicHeader2 = new BasicPskHeader("question", "What's the solution?");
  private static final BasicPskHeader privateHeader1 = new BasicPskHeader("answer", "Choice, the problem is choice.");
  private static final BasicPskHeader privateHeader2 = new BasicPskHeader("answer",
    "But we control these machines; they don't control us!");
  private static final byte[] applicationData = "{\"oracle\":\"candy\", \"forseen\":true}".getBytes();
  ...
  public void testWriteRead() throws Exception {
    ...
    final ByteArrayInputStream asn1OerPaymentBytes = new ByteArrayInputStream(outputStream.toByteArray());
