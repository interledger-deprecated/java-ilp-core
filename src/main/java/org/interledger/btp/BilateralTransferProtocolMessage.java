...
public interface BilateralTransferProtocolMessage extends BilateralTransferProtocolPacket {
  ...
  /**
   * A builder for instances of {@link BilateralTransferProtocolMessage}.
   */
  class Builder {
     ...
     *
     * @return An instance of {@link BilateralTransferProtocolMessage}.
     */
    public BilateralTransferProtocolMessage build() {
      return new Impl(this);
    }

    /**
     * A private, immutable implementation of {@link BilateralTransferProtocolMessage}.
     */
    private static final class Impl implements BilateralTransferProtocolMessage {
