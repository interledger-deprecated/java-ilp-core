...
public interface LedgerTransfer {
	 ...
	 * plugin and can be queried by the host via getInfo. The ledger plugin 
	 * MUST throw an InsufficientPrecisionError if the given amount exceeds 
	 * the supported level of precision.
	 * 
