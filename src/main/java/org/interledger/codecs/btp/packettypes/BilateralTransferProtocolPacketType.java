 ...
 */
public interface BilateralTransferProtocolPacketType {
   ...
   * BilateralTransferProtocolPacketType}. Note that this method only handled standard Interledger packets types.
   * To operate upon non-standard packets, a different method should be used.
   *
   * @param type The integer type.
   *
   * @return An instance of {@link BilateralTransferProtocolPacketType}.
   *
   * @throws InvalidPacketTypeException If the supplied {@code type} is invalid.
   */
  static BilateralTransferProtocolPacketType fromTypeId(final int type) throws InvalidPacketTypeException {
    switch (type) {
  ...
  /**
   * An abstract implementation of {@link BilateralTransferProtocolPacketType}.
   */
  abstract class AbstractBilateralTransferProtocolPacketType implements BilateralTransferProtocolPacketType {

    private final Integer typeIdentifier;

    protected AbstractBilateralTransferProtocolPacketType(final Integer typeIdentifier) {
    ...
    public boolean equals(Object obj) {
      ...
      AbstractBilateralTransferProtocolPacketType that = (AbstractBilateralTransferProtocolPacketType) obj;
