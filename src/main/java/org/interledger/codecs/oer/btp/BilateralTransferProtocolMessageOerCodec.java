...
import org.interledger.codecs.btp.BilateralTransferProtocolMessageCodec;
 ...
 * BilateralTransferProtocolMessage}.</p>
 *
 * @see "http://www.oss.com/asn1/resources/books-whitepapers-pubs/Overview%20of%20OER.pdf"
 */
public class BilateralTransferProtocolMessageOerCodec implements BilateralTransferProtocolMessageCodec {

  @Override
  public BilateralTransferProtocolMessage read(final CodecContext context, final InputStream inputStream)
      throws IOException {
    ...
    return BilateralTransferProtocolMessage.builder()
        .requestId(requestId)
  ...
  @Override
  public void write(final CodecContext context, final BilateralTransferProtocolMessage instance,
