...
public interface QuoteLiquidityResponse extends QuoteResponse {
   ...
   * the curve only applies to the destination account (see {@link QuoteLiquidityRequest#getDestinationAccount()})
   * of the corresponding quote request, then this value will be equal to that address. If the
   * curve applies to other accounts with a certain prefix, then this value will be set to that
   * prefix.</p>
   *
