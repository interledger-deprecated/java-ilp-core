...
public class InterledgerAddressTest {
  ...
  public void testGetValue() throws Exception {
    assertThat(InterledgerAddressBuilder.builder().withValue("g.foo.bob").build().getValue(),
        is("g.foo.bob"));
  }
  ...
  public void test_startsWith_null() throws Exception {
    final InterledgerAddress address = InterledgerAddressBuilder.builder().withValue("g.foo.bob")
        .build();
  ...
  public void test_address_with_null() {
    final InterledgerAddress addressPrefix = InterledgerAddressBuilder.builder().withValue("g.foo.")
        .build();
    try {
  ...
  public void test_address_hashcode() {
    final InterledgerAddress addressPrefix1 = InterledgerAddressBuilder.builder().withValue("g.foo")
        .build();
    final InterledgerAddress addressPrefix2 = InterledgerAddressBuilder.builder().withValue("g.foo")
        .build();
    final InterledgerAddress addressPrefix3 = InterledgerAddressBuilder.builder()
        .withValue("g.foo.").build();
