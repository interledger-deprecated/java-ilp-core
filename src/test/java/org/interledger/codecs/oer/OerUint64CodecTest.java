...
public class OerUint64CodecTest {
    ...
    return Arrays.asList(new Object[][]
        {
            ...
            {new BigInteger("9223372036854775808"), new byte[] {(byte) 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
            // 33
            {new BigInteger("9223372036854775809"), new byte[] {(byte) 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01}},
            // 33
            {new BigInteger("18446744073709551614"), new byte[] {(byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFE}},
            // 34
            {new BigInteger("18446744073709551615"), new byte[] {(byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF}}
        }
    );
  }
  ...
  public void read() throws Exception {
    ...
    final BigInteger actualValue = oerUint64Codec.read(codecContext, byteArrayInputStream).getValue();
