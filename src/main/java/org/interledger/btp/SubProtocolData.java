...
public interface SubProtocolData {
   ...
   *
   * @return An instance of {@link SubProtocolContentType}.
   */
  SubProtocolContentType getContentType();
  ...
  class Builder {
    ...
    private SubProtocolContentType contentType;
    private byte[] data;
    ...
    public Builder textData(final String data) {
      ...
      this.contentType = SubProtocolContentType.TEXT_PLAIN_UTF8;
    ...
    public Builder jsonData(final String data) {
      Objects.requireNonNull(data);
      this.contentType = SubProtocolContentType.APPLICATION_JSON;
      this.data = data.getBytes(StandardCharsets.UTF_8);
      return this;
    }
    ...
    public Builder binaryData(final byte[] data) {
      ...
      this.contentType = SubProtocolContentType.APPLICATION_OCTET_STREAM;
      return this;
    }
    ...
    private static final class Impl implements SubProtocolData {
      ...
      private final String protocolIdentifier;
      private final SubProtocolContentType contentType;
      ...
      @Override
      public SubProtocolContentType getContentType() {
