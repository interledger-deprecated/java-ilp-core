...
/**
 * Test to ensure that the {@link OerIA5StringCodec} properly fails when it cannot read the 
...
public class OerIA5StringCodecTestBadLength {
  ...
  public void test_BadLengthIndicator() throws IOException {
    ...
    /* we now remove a portion of the data, i.e. the length indicator should claim that there
     * are 34 bytes, but we have truncated to 10 bytes */
