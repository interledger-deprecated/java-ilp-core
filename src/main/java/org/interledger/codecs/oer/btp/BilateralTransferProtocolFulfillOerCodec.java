...
import org.interledger.codecs.btp.BilateralTransferProtocolFulfillCodec;
 ...
 */
public class BilateralTransferProtocolFulfillOerCodec implements
    BilateralTransferProtocolFulfillCodec{

  @Override
  public BilateralTransferProtocolFulfill read(final CodecContext context, final InputStream inputStream)
      throws IOException {
    ...
    final byte[] fulfillment = context.read(OerUint256.class, inputStream).getValue();

    final List<SubProtocolData> data = context.read(OerSequenceOfSubProtocolData.class, inputStream)
        .getSubProtocols();

    return BilateralTransferProtocolFulfill.builder()
        .requestId(requestId)
        .transferId(transferId)
        .fulfillment(Fulfillment.of(fulfillment))
        .setSubProtocolData(data)
        .build();
  }

  @Override
  public void write(final CodecContext context, final BilateralTransferProtocolFulfill instance,
    ...
    context.write(OerUint256.class, new OerUint256(instance.getFulfillment().getPreimage()), outputStream);
