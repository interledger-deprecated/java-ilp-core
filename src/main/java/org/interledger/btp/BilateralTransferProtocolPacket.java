...
public interface BilateralTransferProtocolPacket {
  ...
  /**
   * A handler interface that defines all types of {@link BilateralTransferProtocolPacket} to handle. For actual
  ...
  interface Handler<R> {
    ...
    /**
     * The main handler method to coerce an instance of {@link BilateralTransferProtocolPacket} into its actual
     ...
     *   protected String handle(final BilateralTransferProtocolMessage btpMessage) {
     *      // ... do handling here.
    ...
    abstract class AbstractHandler<R> implements Handler<R> {
      ...
      /**
       * Handle an instance of {@link BilateralTransferProtocolMessage}.
       *
       * @param btpMessage An instance of {@link BilateralTransferProtocolMessage}.
       *
       * @return An instance of type {@link R}, in response to the supplied input.
       */
      protected abstract R handle(final BilateralTransferProtocolMessage btpMessage);
      ...
      public final R execute(final BilateralTransferProtocolPacket packet) {
        ...
        if (packet instanceof BilateralTransferProtocolMessage) {
          return this.handle((BilateralTransferProtocolMessage) packet);
        } else {
          throw new BilateralTransferProtocolRuntimeException("Unhandled BilateralTransferProtocolPacket: " + packet);
        }
      }
       ...
       * caller knows that the result is going to be of type {@link BilateralTransferProtocolMessage},
      ...
      public static class HelperHandler<R> extends AbstractHandler<R> {
        ...
        @Override
        protected R handle(BilateralTransferProtocolMessage btpMessage) {
          throw new BilateralTransferProtocolRuntimeException(
  ...
  interface VoidHandler {
     ...
     * upon an unknown result type extending {@link BilateralTransferProtocolPacket}. This class can be used in
     ...
     *   protected void handle(final BilateralTransferProtocolMessage btpMessage) {
     *      // ... do handling here.
     *   }
     * }.execute(decodedPacket); // be sure to call .execute!
     * </code>
    ...
    abstract class AbstractVoidHandler implements VoidHandler {
       ...
       * @param btpMessage An instance of {@link BilateralTransferProtocolMessage}.
       */
      protected abstract void handle(final BilateralTransferProtocolMessage btpMessage);
      ...
      public final void execute(final BilateralTransferProtocolPacket packet) {
        Objects.requireNonNull(packet);
        if (packet instanceof BilateralTransferProtocolMessage) {
          this.handle((BilateralTransferProtocolMessage) packet);
        } else {
          throw new BilateralTransferProtocolRuntimeException("Unhandled BilateralTransferProtocolPacket: " + packet);
        }
       ...
       * BilateralTransferProtocolMessage}, then it is not useful to add boilerplate implementations of the other
      ...
      public static class HelperHandler extends AbstractVoidHandler {
        ...
        @Override
        protected void handle(BilateralTransferProtocolMessage btpMessage) {
          throw new BilateralTransferProtocolRuntimeException(
              "Not yet implemented. Override this method to provide a useful implementation!");
        }
